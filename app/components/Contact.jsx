...
const [result, setResult] = useState("");
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "66979ac7-c7f3-4534-b8a6-70138bc1b0ae");
    ...
    bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto]'>
      <h4 className='text-center mb-2 text-lg font-Ovo'>
        ...
        Life is short to be shy, let's connect!
        </p>
        ...
        <form onSubmit={onSubmit} className='max-w-2xl mx-auto'>
            ...
            text-white rounded-full mx-auto hover:bg-black dutaion-500'>
            Submit <Image src={assets.right_arrow_white} alt='' className='w-4'/> </button>
