    ...
    >
      ...
      className='text-center text-5xl font-Ovo'>
        ...
        className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
            ...
            className='my-6 text-gray font-Ovo dark:text-white'> Tools I use</motion.h4>
            <motion.ul 
            initial={{opacity:0,}}
            whileInView={{opacity:1,}}
            ...
            className=' flex items-center gap-3 sm:gap-5'>
                {toolsData.map((tool, index)=>(
                    ...
                    className='flex items-center justify-center w-12 sm:w-14 aspect-square border border-gray-400 rounded-lg cursor-pointer hover:bg-lightHover 
